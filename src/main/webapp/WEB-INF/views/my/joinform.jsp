...
<main class="Site-content textcenter">
	...
	<form id="myjoin" action="join" method="post">
		<table class="classtable" align="center">
			...
			<tr>
				<td class="classtd"><input type="text" id="user_email" name="user_email"
			...
			<tr>
				<td class="classtd password"><input type="password" id="pw1" name="pw1"
			...
			<tr>
				<td class="classtd password"><input type="password" id="pw2" name="pw2"
			...
			<tr>
				<td class="classtd"><input type="text" id="nickname" name="nickname"
					style="padding: 10px;" size="50" placeholder="2~15자 사이의 한글영문숫자"
					required> <br /> <span id="nicknameResult" class="fontbold"></span></td>
			</tr>
			<tr>
				<td class="classtd"><input type="submit" id="btnstyle" value="회원가입"></td>
			</tr>
		</table>
	</form>
	<span class="returnmsg"><c:out value="${joinmsg }" default="" /></span><br />
	<span class="fs12px">이미 아이디가 있으신가요?&nbsp;&nbsp;&nbsp;&nbsp;<a href="loginform"><b>로그인</b></a></span>
</main>
