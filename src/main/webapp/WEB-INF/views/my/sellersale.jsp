...
<h3>sellersale.jsp</h3>
    ...
    <div class="mypage_category">
        <div class="mypage_category_list list_1_1"><a href="#">판매상품관리</a></div>
	    <div class="mypage_category_list list_1_2"><a href="sellersalelist">판매목록</a></div>
