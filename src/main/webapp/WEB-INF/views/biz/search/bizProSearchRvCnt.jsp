...
<div id="topDiv" class="pt-3 bg-light bg-opacity-75">
	...
	<div class="d-flex justify-content-center">	
		<div class="px-5" style="width: 1150px;">
			<div class="input-group pb-4 d-flex justify-content-center" style="max-width: 1150px">
			      <div class="d-flex justify-content-center">
		...
		<div class="p-3" style="width: 1150px;">
			<ul class="w-100 list-inline">
					<div class="float-start">
						<li class="list-inline-item">
							<h5><strong class="align-middle">${bh_pro } 전문시공 업체</strong></h5>
						</li>
					</div>
					<div class="float-end">	
						<li class="list-inline-item">
							<div class="px-3">
								<div class="btn-group" role="group">
									<button class="btn btn-outline-primary btn-sm" onclick="location.href='/ibara/biz/search/bizProSearchBasic?bh_pro=${bh_pro }'">기본순</button>
									<button class="btn btn-outline-primary btn-sm" onclick="location.href='/ibara/biz/search/bizProSearchStar?bh_pro=${bh_pro }'">별점높은순</button>
									<button class="btn btn-outline-primary btn-sm" onclick="location.href='/ibara/biz/search/bizProSearchRvCnt?bh_pro=${bh_pro }'">리뷰많은순</button>
									<button class="btn btn-outline-primary btn-sm" onclick="location.href='/ibara/biz/search/bizProSearchContCnt?bh_pro=${bh_pro }'">계약많은순</button>
								</div>											
							</div>
						</li>
					</div>
				...
				<div class="card border-light mb-2"
					...
					<div class="card-body">
						<div class="card-title">
							<strong style="font-size: 16px; color: #1e90ff;">${bizHome.bh_name }</strong> &nbsp; <span style="color: gold;">★</span> <span
								style="font-size: 13px; color: #b1b8c0;"> ${bizHome.bizSearchTempDto.bst_staravg }</span>
						</div>
