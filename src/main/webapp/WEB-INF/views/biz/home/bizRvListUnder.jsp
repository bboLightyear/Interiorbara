	...
	<table class="" border="1">
		...
		<c:forEach items="${bizRvList }" var="dto">
			...
			<tr class="">
				...
				<td class="">
					<a href="../review/bizRvContentView?br_no=${dto.br_no }&memno=1000&inteno=${inteno }">${dto.br_content }</a>
				</td>
		...
		<tr>
			<td colspan="6"><a href="../review/bizRvWriteView?inteno=${inteno }">리뷰쓰기</a> <a href="../review/bizRvList?inteno=${inteno }">첫페이지로</a></td>
	...
	<form action="bizRvList" method="post">
		<c:if test="${searchVO.totPage>1}">
			<c:if test="${searchVO.page>1 }">
				<a href="../review/bizRvList?page=1&inteno=${inteno }"><i class="fa-solid fa-angles-left"></i></a>
				<a href="../review/bizRvList?page=${searchVO.page-1}&inteno=${inteno } "><i class="fa-solid fa-circle-chevron-left"></i></a>
			</c:if>
			...
			<c:forEach begin="${searchVO.pageStart }" end="${searchVO.pageEnd }" var="i">
				<c:choose>
					...
					<c:otherwise>			
						<a href="../review/bizRvList?inteno=${inteno }&page=${i }&sk=${resk}&br_content=${br_content==true?'br_content':''}
			...
			<c:if test="${searchVO.totPage > searchVO.page}">
				<a href="../review/bizRvList?page=${searchVO.page+1}&inteno=${inteno }"><i class="fa-solid fa-angles-right"></i></a>
				<a href="../review/bizRvList?page=${searchVO.totPage}&inteno=${inteno }"><i class="fa-solid fa-circle-chevron-right"></i></a>
			</c:if>
		</c:if>
<%-- 		<div>
			<c:choose>
