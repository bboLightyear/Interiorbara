						...
						<div id="OHPhotoEditView-main-sector2">
                            ...
                            <div id="OHPhotoEditView-main-sector2-2">
                                ...
                                <div id="sector2-2-layer1">
                                    <input id="layer1-title" type="text" maxlength="30" name="pb_title" value="${pb_dto.pb_title }" placeholder="제목을 입력하세요." />
                                </div>

                                <div id="sector2-2-layer2">
                                    <textarea id="layer2-content" maxlength="200" name="pb_content" rows="10" cols="30" placeholder="내용을 입력하세요." >${pb_dto.pb_content }</textarea>
                                </div>	   				
