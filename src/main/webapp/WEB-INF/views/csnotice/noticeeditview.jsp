	...
	<div class="cs_write_wrap_form">
		...
		<form action="noticeeditproc" method="post" enctype="multipart/form-data">
			...
			<div class="cs_write_wrap_form_wrap_div">
				<div class="cs_write_wrap_form_div">
					...
					<select class="cs_write_wrap_form_div_selbox" name="qnadiv">
						<option value="qq" ${notice_content.nbqnadiv eq 'qq' ? 'selected' : '' }>퀵견적</option>
						<option value="oh" ${notice_content.nbqnadiv eq 'all' ? 'selected' : '' }>우리집 자랑하기</option>
						<option value="biz" ${notice_content.nbqnadiv eq 'all' ? 'selected' : '' }>업체 관련</option>
						<option value="pf" ${notice_content.nbqnadiv eq 'all' ? 'selected' : '' }>로그인/회원정보</option>
						<option value="sh" ${notice_content.nbqnadiv eq 'all' ? 'selected' : '' }>소품샵</option>
					</select>
			...
			<div class="cs_write_wrap_form_title">
				...
				<input type="text" class="cs_write_wrap_form_title_it" name="nbtitle" value="${notice_content.nbtitle }" onfocus="clearInput(this)"/>
			...
			<div class="cs_write_wrap_form_wrap_content">
				<div class="cs_write_wrap_form_content">
					...
					<textarea type="text" class="cs_write_wrap_form_content_ta" name="nbcontent">${notice_content.nbcontent }</textarea>
