...
@Service
public class BizHomeInfoViewService implements BizServiceInter {

	private SqlSession sqlSession;

	public BizHomeInfoViewService(SqlSession sqlSession) {
	...
	public void execute(Model model) {
		...
		System.out.println("service BizHomeInfoViewService>>>");
