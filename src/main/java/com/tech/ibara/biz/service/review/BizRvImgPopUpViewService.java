...
@Service
public class BizRvImgPopUpViewService implements BizServiceInter {

	private SqlSession sqlSession;
	
	public BizRvImgPopUpViewService(SqlSession sqlSession) {
	...
	public void execute(Model model) {
		...
		System.out.println("service BizRvImgPopUpViewService>>>");
